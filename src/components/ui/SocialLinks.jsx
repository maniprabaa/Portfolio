...
export default function SocialLinks({ className = '', iconClassName = 'h-4 w-4' }) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      {links.map(({ name, href, icon: Icon }) => (
        <a
          ...
          aria-label={name}
          className="inline-flex items-center justify-center border border-line p-2.5 text-fg-2 transition hover:border-mint/40 hover:text-mint"
        >
